...
> 学习起点：2026-08-23 第一批 5 个模块（PL101/201/208/210/214），用户后续会继续投放剩余模块。

- 入口: `smes-v61-training/README.md`（模块清单 + 差异判定图例）
- 模块文件: `PL101-生产模型管理.md`（45 点位）`PL201-设备维保.md` `PL208-追溯.md` `PL210-看板管理.md` `PL214-IIoT.md`
