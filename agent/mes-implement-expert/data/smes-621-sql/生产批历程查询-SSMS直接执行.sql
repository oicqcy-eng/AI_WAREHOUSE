/* ============================================================
 * 生产批历程查询（过程追溯）— SSMS 直接执行版（2026-08-19）
 *
 * 【使用方法】
 *   1. SSMS 连接 sMES_Home_Prod（192.168.200.18，只读账号即可）
 *   2. 把下面 @lotno 变量的值改成要查的批号
 *   3. 整段执行（F5）
 *
 * 输出列: 生产批号/类型/作业站/作业名称/订单/产品/品名/图号/规格/
 *         输入/良品/不良/短少/多余/开始/结束/人时/机时/流程/工单/
 *         客户/主批号/客户批号/暂停处置/目的站点
 * 说明: 全程履历含开立/报工/暂停/分批/并批
 * ============================================================ */
DECLARE @lotno NVARCHAR(50) = N'MO1012608050057-001';  -- ★ 改这里查任意批号
