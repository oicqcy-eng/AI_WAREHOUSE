 ...
 * 【工序译名】重庆工序/工站/作业站 OPNO 译名以 data/smes-621-sql/工序作业站字典.md 为准，勿凭记忆：
 *   LW=冷弯（非拉弯，2026-08-14 用户确认）、RCL-H=热处理、DD-H=电镀、PWPT-H=喷丸、
 *   LHZP-H=冷弯分组、MM=磨面、FZBZ-H=分组包装。报表翻译 OPNO 前必查字典。
